...
import { netlify1 } from "../assets";
import { SectionWrapper } from "../hoc";
import { projects } from "../constants";
import { fadeIn, textVariant } from "../utils/motion";

const ProjectCard = ({ index, name, description, tags, image, source_code_link, app_view_link }) => {
  return (
      ...
      >
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute inset-0  gap-2 flex justify-end m-3 card-img_hover">
            ...
            <div
              onClick={() => window.open(app_view_link, "_blank")}
              className="black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer"
            >
              <img src={netlify1} alt="source code" className="w-1/2 h-1/2 object-contain" />
            </div>
          </div>
        </div>
